...
/* {OPEN:CLASS} { a: 1, b: 2, sha1: "OVERRIDDEN" } */
public class Opportunity extends BaseOpportunity implements AutoEmailable, TransformRegistrar, AnotherInterface
{
/* {POSTOPEN:CLASS} { a: 1, b: 2, sha1: "this would be autogenerated based on the text from the OPEN - POSTOPEN" } */
...
/* {PRECLOSE:CLASS} { a: 1, b: 2, sha1: "this would be autogenerated based on the text from the PRECLOSE - CLOSE" } */    
}
/* {CLOSE:CLASS} { a: 1, b: 2 */
