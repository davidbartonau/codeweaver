...
/* {PREOPEN:CLASS} { a: 1, b: 2sha1: "OVERRIDE" } */
import new.package.*;
...
{
/* {POSTOPEN:CLASS} { a: 1, b: 2, sha1: "autogenerate this" } */
    ...
    {
        /* {OPEN:preCommit} { a: 1, b: 2, sha1: "OVERRIDE" } */
        // Do nothing
    ...
    public void registerTransforms()
    {
        MasterTransform.create(TRANSFORM_TYPE_AUTO_MSG)
                        ...
                        .add("firstItem", FirstItem.class)
                        /* {POSTOPEN:MasterTransformAdd} { a: 1, b: 2, sha1: "OVERRIDE" } */
