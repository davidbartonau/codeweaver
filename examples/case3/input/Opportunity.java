...
/* {POSTOPEN:CLASS} { a: 1, b: 2 } */
    ...
    /* {PREOPEN:validate} { a: 1, b: 2 } */
    @Override
    public void validate(ValidationContext context)
    {
        /* {OPEN:validate} { a: 1, b: 2 } */
        super.validate(context); 
        
        if (/* {OPEN:validateLeadStatusCondition} { a: 1, b: 2 } */getLeadStatus() == null/* {CLOSE:validateLeadStatusCondition} { a: 1, b: 2 } */)
        {
    ...
    public void registerTransforms()
    {
        MasterTransform.create(TRANSFORM_TYPE_AUTO_MSG)
                        /* {OPEN:MasterTransformAdd} { a: 1, b: 2 } */
