...
/* {POSTOPEN:CLASS} { a: 1, b: 2sha1: "autogenerate this" } */
    ...
    public void validate(ValidationContext context)
    {
        ...
        if (/* {PREOPEN:validateLeadStatusCondition} { a: 1, b: 2, sha1: "OVERRIDE" } */conditionY () && /* {OPEN:validateLeadStatusCondition} { a: 1, b: 2, sha1: "autogenerate this" } */getLeadStatus() == null/* {CLOSE:validateLeadStatusCondition} { a: 1, b: 2 } */ || conditionX()/* {POSTCLOSE:validateLeadStatusCondition} { a: 1, b: 2, sha1: "OVERRIDE" } */)
        {
